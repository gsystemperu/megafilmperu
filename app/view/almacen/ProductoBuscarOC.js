Ext.define('megafilmperu.view.almacen.ProductoBuscarOC', {
    ...
    initComponent:function(){
        me = this;
        storeProducto  = Ext.create('megafilmperu.store.ProductosOrdenCompra');
        storeProducto.load({
          params:{
            idprov : me.getProveedor()
          }
        });
        storeTipoProd  = null; //Ext.create('megafilmperu.store.TipoDeProductos');
        Ext.apply(me,{
            items:[
