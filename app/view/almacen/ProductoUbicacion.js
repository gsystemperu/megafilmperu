...
Ext.define('megafilmperu.view.almacen.ProductoUbicacion', {
    extend: 'Ext.window.Window',
    xtype:'wProductoUbicacion',
    requires:['megafilmperu.view.almacen.AccionesUbicacion'],
    modal:true,
    ...
    getItems:function(codigoserie){
      storeA = Ext.create('megafilmperu.store.Almacenes');
      storeS = Ext.create('megafilmperu.store.AlmacenSecciones');
      return obj = [
        {
            xtype: 'container',
            scrollable: true,
