Ext.define('megafilmperu.view.almacen.ListaSeriesInventario', {
    extend: 'Ext.form.Panel',
    xtype: 'wListaSeriesInventario',
    alias: 'widget.wListaSeriesInventario',
    requires: [
        'Ext.layout.container.HBox',
        'megafilmperu.view.almacen.ListaSeriesInventarioController',
        'Ext.grid.*',
        'Ext.grid.column.*',
        'Ext.form.field.*',
    ],
    ...
    controller: 'almacen-listaseriesinventario', //**CAMBIAR
    initComponent: function () {
        ...
        Ext.apply(this, {
            items: [{
                ...
                items: [{
                    xtype: 'grid',
                    itemId: 'dgvSeriesProductosInventario', //**CAMBIAR
                    reference: 'dgvSeriesProductosInventario', //**CAMBIAR
                    store: st,
                    ...
                    bbar: [{
                        ...
                        },
                        {
                            ...
                            text: 'ACEPTAR',
                            scale: 'medium',
                            handler: 'onClickGuardarSeriesUnidad'
                        },
                        '->',
                        {
                            xtype: 'numberfield',
