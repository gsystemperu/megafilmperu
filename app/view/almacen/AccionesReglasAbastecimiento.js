...
Ext.define('megafilmperu.view.almacen.AccionesReglasAbastecimiento', {
    ...
    onClickIngresar:function(){
        Ext.create('megafilmperu.view.almacen.IngresarAbastecimiento');
    },
    ...
    onClickFormularioProveedor :function(btn){
        var win   = Ext.create('megafilmperu.view.almacen.FormProveedor',{control: btn.control.toString()});
    },
