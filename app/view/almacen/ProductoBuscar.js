Ext.define('megafilmperu.view.almacen.ProductoBuscar', {
    ...
    initComponent:function(){
        me = this;
        console.log(this.getVentana());
        storeProducto  = Ext.create('megafilmperu.store.Productos');
        storeTipoProd  = Ext.create('megafilmperu.store.TipoDeProductos');
        Ext.apply(me,{
            items:[
