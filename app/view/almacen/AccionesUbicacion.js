...
Ext.define('megafilmperu.view.almacen.AccionesUbicacion', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.acciones-ubicacion',
    requires:['megafilmperu.util.Rutas','megafilmperu.util.Util'],
    ...
    onClickGuardarUbicacion:function(){
        ...
        Ext.Ajax.request({
            url :megafilmperu.util.Rutas.productoGuardarUbicacion,
            params:{
            ...
            success:function(response){
               var rs = megafilmperu.util.Util.decodeJSON(response.responseText);
               if(rs.error>0){
                 me.getView().unmask();
