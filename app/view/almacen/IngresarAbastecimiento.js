Ext.define('megafilmperu.view.almacen.IngresarAbastecimiento', {
    extend: 'Ext.window.Window',
    xtype: 'wingresarabastecimiento',
    requires: [
        'Ext.grid.plugin.*',
        'megafilmperu.view.almacen.AccionesReglasAbastecimiento',
    ...
    initComponent: function () {
        ...
        var storeDetalle      = Ext.create('megafilmperu.store.DetalleAbastecimiento');
        me = this;
        Ext.applyIf(me, {
            items: [{
                    xtype: "form",
                    ...
                    url: megafilmperu.util.Rutas.abastecimientoGuardar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
