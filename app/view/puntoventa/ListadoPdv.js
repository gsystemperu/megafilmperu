Ext.define('megafilmperu.view.puntoventa.ListadoPdv', {
    ...
    requires: [
        ...
        'Ext.form.field.*',
        'Ext.panel.Panel',
        'megafilmperu.view.puntoventa.AccionesListadoPdv',
    ...
    initComponent: function () {
        var storeCotiFacturar    = Ext.create('megafilmperu.store.PuntoVentaPagos');
