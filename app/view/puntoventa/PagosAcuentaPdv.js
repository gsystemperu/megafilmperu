Ext.define('megafilmperu.view.puntoventa.PagosAcuentaPdv', {
    ...
    requires   : [
        ...
        'megafilmperu.util.*',
        'Ext.grid.*',
        'megafilmperu.view.puntoventa.AccionesPagosAcuentaPdv'
    ],
    config : {
        nombre : '',
        monto  : 0,
   ...
   controller:'acciones-pagosacuentapdv',
    ...
    {
        me = this;
        __store = Ext.create('megafilmperu.store.PagosAcuenta');
        ...
        Ext.Ajax.request({
              url : megafilmperu.util.Rutas.facturacionBuscarPagosAcuenta,
              params:{
