Ext.define('megafilmperu.view.ventas.AccionesGuiaRemision', {
    ...
    onClickGuardarGuiaRemision:function(btn){
        ...
        if (_form.isValid())
        {
            ...
            Ext.ComponentQuery.query('#txtJsonDetalleGuiaRemision')[0].setValue(JSON.stringify(_dataDetalle));
            Ext.ComponentQuery.query('#idtiendaguiaremision')[0].setValue(1); // idtienda
            ...
            _form.submit({
                ...
                success: function (form, action) {
                    ...
                    var objrpt = window.open( megafilmperu.util.Rutas.ImprimirguiaRemision+ 'id='+ action.result.error , "", "width=700,height=900");
                    //setTimeout(function(){ objrpt.close(); }, 2000);
            ...
            megafilmperu.util.Util.showErrorMsg('Ingresar los datos de la guia de remisión!!');
        }
