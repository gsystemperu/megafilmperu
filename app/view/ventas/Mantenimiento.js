Ext.define('megafilmperu.view.ventas.Mantenimiento', {
    ...
    requires: [
        ...
        'Ext.toolbar.Toolbar',
        'Ext.form.Panel',
        'megafilmperu.view.ventas.AccionesMantenimiento'
    ],
    autoShow: true,
    width: 900,
    height: 400,
    ...
    getItems: function () {
        ...
        var storeME = Ext.create('megafilmperu.store.ModoEntrega');
        var storeFP = Ext.create('megafilmperu.store.FormaPago');
        var storeVE = Ext.create('megafilmperu.store.Vendedores');
        ...
        var _obj = [{
            ...
            items: [{
                ...
                },
                {
                    ...
                    items: [{
                            xtype: 'form',
                            url: megafilmperu.util.Rutas.formaPagoGuardar,
                            flex: 1,
                ...
                },
                {
                    ...
                    items: [{
                            xtype: 'form',
                            url: megafilmperu.util.Rutas.modoEntregaGuardar,
                ...
                },
                {
                    ...
                    items: [{
                            xtype: 'form',
                            url: megafilmperu.util.Rutas.vendedorGuardar,
                ...
                {   //@ Panel Presentacion
                    ...
                    items: [{
                            xtype: 'form',
                            url: megafilmperu.util.Rutas.presentacionGuardar,
