    Ext.define('megafilmperu.view.ventas.ListaSeriesUnidadesVenta', { 
        extend: 'Ext.form.Panel',
        xtype: 'wListaSeriesUnidadesVenta',
        alias: 'widget.wListaSeriesUnidadesVenta', 
        requires: [
            'Ext.layout.container.HBox',
            'megafilmperu.view.ventas.ListaSeriesUnidadesVentaController',
            'Ext.grid.*',
            'Ext.grid.column.*',
            'Ext.form.field.*',
        ],
