Ext.define('megafilmperu.view.ventas.EditarCotizacion', {
    ...
    initComponent: function () {
        ...
        //var storeDetCot = Ext.create('megafilmperu.store.CotizacionesDetalle');
                            ...
                            items: [{
                                ...
                                },
                                {
                                    ...
                                    buttons: [{
                                            ...
                                            text: 'Cancelar',
                                            scale: 'medium',
                                            glyph: megafilmperu.util.Glyphs.getGlyph('cancelar'),
