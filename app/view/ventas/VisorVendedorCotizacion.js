Ext.define('megafilmperu.view.ventas.VisorVendedorCotizacion', {
    ...
    getItems: function () {
        var storeVendedor = Ext.create('megafilmperu.store.Vendedores');
        var storeEstadistica = Ext.create('megafilmperu.store.CotizacionesEstadisticaVendedor');
        var obj = [{
                xtype: 'container',
                flex: 0.8,
                layout: {
