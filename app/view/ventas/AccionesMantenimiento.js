Ext.define('megafilmperu.view.ventas.AccionesMantenimiento', {
    ...
    onClickEliminarFormaPago:function(button, event, eOpts){
        ...
        if (rec) {
               Ext.Ajax.request({
                   url :megafilmperu.util.Rutas.formaPagoEliminar,
                   params:{
    ...
    onClickEliminarModoEntrega:function(button, event, eOpts){
        var rec = button.getWidgetRecord();
          if (rec) {
               Ext.Ajax.request({
                   url :megafilmperu.util.Rutas.modoEntregaEliminar,
                   params:{
    ...
    onClickEliminarVendedor:function(button, event, eOpts){
        ...
        if (rec) {
               Ext.Ajax.request({
                   url :megafilmperu.util.Rutas.vendedorEliminar,
                   params:{
    ...
    onClickEliminarPresentacion:function(button, event, eOpts){
        var rec = button.getWidgetRecord();
            if (rec) {
               Ext.Ajax.request({
                   url :megafilmperu.util.Rutas.presentacionEliminar,
                   params:{
