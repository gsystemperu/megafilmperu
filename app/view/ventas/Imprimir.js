Ext.define('megafilmperu.view.ventas.Imprimir', {
    ...
    getItems:function(){
      var storeOrientacion = Ext.create('megafilmperu.store.PosicionReporte');
      var storeFormato     = Ext.create('megafilmperu.store.FormatoReporte');
      var storeFirmas     = Ext.create('megafilmperu.store.Firmas');
