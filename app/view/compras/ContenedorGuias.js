Ext.define('megafilmperu.view.compras.ContenedorGuias', {
  ...
  requires: [
   ...
   // 'megafilmperu.view.compras.AccionesContenedorGuias',
    'megafilmperu.view.compras.IngresoGuia',
  ...
  mostrarIngresoGuias: function () {
    ...
    if(_rec){
       ...
       Ext.ComponentQuery.query('#idordencompra')[0].setValue(_rec.get('id'));
