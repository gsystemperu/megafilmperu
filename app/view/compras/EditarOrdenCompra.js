Ext.define('megafilmperu.view.compras.EditarOrdenCompra', {
    extend: 'Ext.panel.Panel',
    xtype: 'weditarordencompra',
    requires: [
        'Ext.grid.plugin.*',
        'megafilmperu.view.compras.AccionesOrdenCompraEditar',
            ...
            items: [
                {
                    ...
                    url: megafilmperu.util.Rutas.ordenCompraEditar,
                    items: [{
                            xtype: 'panel',
                            flex: 1,
                            frame: false,
