Ext.define('megafilmperu.view.compras.PagosAcuenta', {
    ...
    requires   : [
        ...
        'megafilmperu.util.*',
        'Ext.grid.*',
        'megafilmperu.view.compras.AccionesPagosAcuenta'
    ...
    initComponent: function()
    {
        ...
        Ext.Ajax.request({
              url : megafilmperu.util.Rutas.ordenCompraBuscarPagoAcuenta,
              params:{
