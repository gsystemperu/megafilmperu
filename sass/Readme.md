...
folder are mapped to the application's root namespace, 'megafilmperu'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "megafilmperu"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'megafilmperu' in the same way
as `"megafilmperu/sass/src"`.
